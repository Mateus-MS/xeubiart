    ...
    render() {
        return html`
            <button 
                ...
                class="${this.styles.classes} ${this.classes} cursor-pointer flex items-center justify-center gap-2 disabled:bg-gray-300 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:shadow-none transition-all" .disabled=${this.disabled}>
